...
public class HuffmanCompressionoldold{
    ...
    public void printText(String str) {
        ...
        for (Character i : codeMap.keySet()) {
            int ascii = (int) i;
            System.out.println(ascii + ":" + codeMap.get(i));
        }
    }
    ...
    public static void main(String[] args) {
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            new HuffmanCompressionoldold();
            HTreeNode root = HuffmanCompressionoldold.createHFMTree (list);
            HuffmanCompressionoldold.makeTreeCode(root, "");
            HuffmanCompressionoldold.makeCodeMap(root);
            new HuffmanCompressionoldold().printText(str);
