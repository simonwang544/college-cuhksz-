...
string Date::toString()
{
   ...
   {
    case JANUARY:
        print_string_2 = integerToString(day)+"-Jan-"+ integerToString(year);
        break;
    case FEBRUARY:
      print_string_2 = integerToString(day)+"-Feb-"+ integerToString(year);
      break;
   case MARCH:
      print_string_2 = integerToString(day)+"-Mar-"+ integerToString(year);
      break;
   case APRIL:
      print_string_2 = integerToString(day)+"-Apr-"+ integerToString(year);
      break;
   case MAY:
      print_string_2 = integerToString(day)+"-May-"+ integerToString(year);
      break;
   case JUNE:
      print_string_2 = integerToString(day)+"-Jun-"+ integerToString(year);
      break;
   case JULY:
      print_string_2 = integerToString(day)+"-Jul-"+ integerToString(year);
      break;
   case AUGUST:
      print_string_2 = integerToString(day)+"-Aug-"+ integerToString(year);
      break;
   case SEPTEMBER:
      print_string_2 = integerToString(day)+"-Sep-"+ integerToString(year);
      break;
   case OCTOBER:
      print_string_2 = integerToString(day)+"-Oct-"+ integerToString(year);
      break;
   case NOVEMBER:
      print_string_2 = integerToString(day)+"-Nov-"+ integerToString(year);
      break;
   case DECEMBER:
      print_string_2 = integerToString(day)+"-Dec-"+ integerToString(year);
      break;
   }
